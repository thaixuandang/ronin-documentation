...
When transacting on Katana, you can fine-tune transaction settings. To access the settings, click the cog icon on the transaction panel on the **Swap** or **Liquidity pool** pages.
