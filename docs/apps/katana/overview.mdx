...
import switchSwap from './assets/katana-switch-swap.gif'
...
:::info Note
Katana is transitioning to the next version of the AMM, Katana v3, which introduces new features and improvements. The Katana v3 upgrade includes a new fee structure, tiered fees based on the type of tokens being swapped, and improved oracles.

Both v2 and v3 versions of Katana are operational, and you can choose to interact with either version.
:::
