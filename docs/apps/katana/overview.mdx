...
The feature experience differs between Katana web and Wallet Swap in Ronin Wallet. Here's a comparison:

|Feature|Katana web|Wallet Swap|
|---|---|---|
|Swap|✅|✅ \*|
|Pool|✅|❌|
|Farm|✅|❌|

\*Each swap transaction using Wallet Swap in the Ronin Wallet mobile app and browser extension incurs a development fee of 0.5% of the transaction value.
...
2. User icon: this opens the page for your connected address in [Ronin Block Explorer](app.roninchain.com).
...
When transacting on Katana web or swapping using Wallet Swap, you can fine-tune transaction settings. To access the settings, select the cog icon in the top right-hand corner of the transaction panel.
