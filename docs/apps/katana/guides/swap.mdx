...
### Swap on Katana vs on Ronin Wallet
...
Your transaction is now submitted to the blockchain. When it is completed, Ronin Wallet displays a confirmation screen. Close it or click **View on explorer** to see the detailed information about the transaction.
