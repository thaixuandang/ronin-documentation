...
The swap interface is different for desktop and mobile users:

* Desktop users: use the Swap feature in the Ronin web app.
* Mobile users: use the Swap feature in the Ronin Wallet mobile app.
:::
...
:::info Swap fee
When you swap tokens in the Ronin Wallet mobile app, each swap transaction incurs a fee of 0.5% of the transaction value.
:::
