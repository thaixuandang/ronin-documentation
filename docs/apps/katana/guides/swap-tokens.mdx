...
In Katana v2, the fees are fixed at the following rates:
...
In Katana v3, the fees are tiered based on the type of tokens being swapped. The higher the volatility of the token pair, the higher the fee. For more information, see [Create a liquidity pool](create-pool.mdx).
