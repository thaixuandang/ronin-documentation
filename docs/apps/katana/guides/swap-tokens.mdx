...
## Routing
The new algorithm, combined with the updated router smart contract, enables you to leverage more liquidity sources for your swaps, including both Katana V2 pools and Katana V3 pools. This allows you to receive more output tokens compared to the old router, which only sourced liquidity from Katana V2 pools.
