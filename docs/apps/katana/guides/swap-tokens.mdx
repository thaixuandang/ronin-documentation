...
The fees for swapping tokens on Katana vary depending on the version of Katana you are using.

#### Katana v2

In Katana v2, the fee structure is as follows:

| Fee type | Ronin web app | Wallet Swap |
| --- | --- | --- |
...
Katana v3 introduces a new fee structure that allows LPs to choose the fee tier that best suits their trading pairs. The fee structure is designed to accommodate different types of trading pairs, such as meme coins, sheet coins, and stablecoins.

The fee tiers in Katana v3 are as follows:

* 1% = 0.85% LP fee + 0.15% Ronin Treasury fee (meme coins, sheet coins)
* 0.3% = 0.25% LP fee + 0.05% Ronin Treasury fee (as in v2)
* 0.01% = 0.005% LP fee + 0.005% Ronin Treasury fee (stablecoins)
