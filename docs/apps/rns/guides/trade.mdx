...
### Transfer an RNS name in Ronin Wallet {#gift-rns-ronin-wallet}

1. Open **Ronin Wallet**, select **Collectibles** (mobile app) or **NFTs** (browser extension), and then select **RNS**.
...
### Gift an RNS name in Mavis Market {#gift-rns-mavis-market}
...
### Gift an RNS name using Ronin Gifting Portal
